...
![vue双向数据绑定的原理](./img/vue_02.png)

## 3、vue 的生命周期有哪些？

<img src="./img/vue_03.png" alt="vue生命周期图" style="zoom:30%;" /> <img src="./img/vue_03_1.png" alt="vue生命周期图尚硅谷" style="zoom:30%;" />
...
<img src="./img/array.png" alt="Array对象方法" style="zoom:80%;" />
