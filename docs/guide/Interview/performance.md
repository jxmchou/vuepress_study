...
（2）在**安全方面**，CDN 有助于防御 DDoS、MITM 等网络攻击：
...
- [CDNJS](https://cdnjs.com/) 外国网站

## 二、懒加载

### 1. 懒加载的概念

懒加载也叫做延迟加载、按需加载，指的是在长网页中延迟加载图片数据，是一种较好的网页性能优化的方式。**将不关键的资源延后加载。**
...
注意：`data-xxx` 中的`xxx`可以自定义，这里我们可以使用`data-src`来定义。
...
- [NPM 关于 VueLazyload 的介绍](https://www.npmjs.com/package/vue-lazyload)
- [GitHub 关于 Vue-Lazyload 的介绍](https://github.com/hilongjw/vue-lazyload)
...
- [lodash.debounce](https://www.lodashjs.com/docs/lodash.debounce) debounced（防抖动）函数
- [lodash.throttle](https://www.lodashjs.com/docs/lodash.throttle) 节流函数
