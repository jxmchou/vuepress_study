...
- 存在问题：
  - 新增属性、删除属性, 界面不会更新。
    ...
    ```js
     新增：
     this.$set(this.xxx,'name','张三')
     import Vue from 'vue'
     Vue.set(this.xxx,'name','张三')
     删除：
     this.$delete(this.xxx,'age')
     import Vue from 'vue'
     Vue.delete(this.xxx,'age')
    ```
  ...
  - 直接通过下标修改数组, 界面不会自动更新。
      ```js
     1. this.$set(this.hobby,0,'学习')
     import Vue from 'vue'
     Vue.set(this.hobby,0,'学习')
     2. this.hobby.splice(0,1,'打游戏')
     ```
