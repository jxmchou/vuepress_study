...
>
> 如果仅仅简单使用,可先只看(必看)本笔记的: 点击跳转 Ctrl + 鼠标左键<br>
> [①高层命令](#四、高层命令-★)<br>
> [②分支部分](#六、分支)<br>
> [③数据恢复](#九、数据恢复)<br>
> [④远程操作](#_1、团队协作流程)<br>
...
>
>![2022010902.png](/img/2022010902.png)
>
...
>
>![202201092247.png](/img/202201092247.png) 
...
>2. 图示
>
>   ![列出仓库中最大的几个对象及其文件名](/img/git2.png)
...
>1. 删除前截图
>
>  ![删除大文件前大小.png](/img/git_delete_from.png)
>
>2. 删除后截图
>
>  ![删除大文件后大小.png](/img/git_delete_to.png)
>
>3. 删除多个文件后
>
>   ![image-20210508182039450.png](/img/image-20210508182039450.png)
...
>4. 解决结果截图
>
>   ![/img/image-20210510172159472.png](/img/image-20210510172159472.png)
...
>
> ![/img/image-20210510180539437.png](/img/image-20210510180539437.png)
> ![/img/image-20210510181407805.png](/img/image-20210510181407805.png)
>
>3. 问题解决:
>
>    ![image-20210510180757993](/img/image-20210510180757993.png)
...
>3. 截图示例
>
>   > ![Git 切换远程仓库地址](/img/Git_commit_.png)
...
>Ⅰ- 当我撰写 [ commit ] 信息没注意到,以为是对的时候直接提交 --> 因为本人提交笔记时喜欢按 [ ↑ ] 找到之前的提交信息进行修改
>
>![/img/image-20210813153403664.png](/img/image-20210813153403664.png)
>
>Ⅱ- 此时可以看到,错误的 [ commit ] 已经提交了 (当然,适用场景不只是commit ,也可错误代码之类的)
>
...
>* 但是你查看提交记录,会发现之前错误的commit已经被覆盖
>
>![/img/image-20210813155339300.png](/img/image-20210813155339300.png)
